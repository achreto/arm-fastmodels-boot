...
#define PDIR_BASE 0x1000

// base address of the page table
#define PTABLE_BASE 0x2000


// the output address to be mapped
#define OUTPUT_ADDR 0x3000

// the size of the mapping
#define MAP_SIZE 0x1000

#define LARGE_OUTPUT_ADDR (2 * 1024 * 1024)
#define LARGE_MAP_SIZE 0x100000

int vrs_test() {
    MSG("Running VRS tests for: x86_32_pagetable\n");
    ...
    volatile uint32_t *pdir = (uint32_t *)(DIRECT_ACCESS_BASE + PDIR_BASE);
